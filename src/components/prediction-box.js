  ...
  return (
    <div className="group relative">
      <div className="aspect-w-1 aspect-h-1 bg-gray-200 rounded-md overflow-hidden">
        <div className="relative px-4 py-5 flex items-center space-x-3 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500">
          <ChevronRightIcon
            width={20}
            color={
        ...
        <div className="mt-2">
          {myPrediction && (
            <Button
              className={cs([
                "w-full bg-indigo-600 border border-transparent py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700",
